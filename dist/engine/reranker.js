 ...
 */
function rerankRRF(resultsByProvider, k) {
    // Track ranks per URL per provider
    const urlRanks = new Map();
 ...
 */
function rerankScore(resultsByProvider) {
 ...
 */
export function rerank(resultsByProvider, options) {
    let ranked;
    switch (options.strategy) {
        ...
        case "none":
            ...
            ranked = deduplicate(Array.from(resultsByProvider.values()).flat());
